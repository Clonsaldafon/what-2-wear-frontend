...
<template>
  <div class="menu-overlay">
    <div
      class="menu-overlay__close-button-wrapper"
      method="dialog"
    >
      <CrossButton @click="onClose" />
    </div>
